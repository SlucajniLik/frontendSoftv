...
function ProfileA() {
 ...
 image: ""
  ...
  return (
    ...
    <Link   style={{color:"white", textDecoration: "none" }} to={"/UpdateProfile/"+userProfile.id+"/"+userProfile.email}   ><Button   className="w-100"    variant="success" name="updateProfle"  >Azuriraj</Button> </Link>
        </Card.Body>
